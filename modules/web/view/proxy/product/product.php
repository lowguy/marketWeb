        ...
        <div class="searchbox">
            <div class="pull-left">
                <div class="form-group">
                    <a class="function-button" href="/proxy/product/marketproduct?uid=<?php echo $_GET['uid'];?>">
                ...
                <tr>
                    ...
                    <td>
                        <button class="btn-operate change-status btn-edit">
                            <a href="/proxy/product/edit?product={$item['product_id']}">修改</a>
                        </button>
                        <button class="btn-operate change-status btn-apr-cancel" data-id="{$item['product_id']}">
